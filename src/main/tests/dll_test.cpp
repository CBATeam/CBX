...
#define MAJOR_VERSION_CALL __MAJOR_VERSION_CALL(CBX_VENDOR_NAMESPACE,CBX_APP_NAMESPACE)

#define __MINOR_VERSION_CALL(VENDOR,APP)  JOIN_VENDOR_APP(VENDOR,APP,get_version_minor)
#define MINOR_VERSION_CALL __MINOR_VERSION_CALL(CBX_VENDOR_NAMESPACE,CBX_APP_NAMESPACE)

#define __PATCH_VERSION_CALL(VENDOR,APP)  JOIN_VENDOR_APP(VENDOR,APP,get_version_patch)
#define PATCH_VERSION_CALL __PATCH_VERSION_CALL(CBX_VENDOR_NAMESPACE,CBX_APP_NAMESPACE)
