...
function(copy_template component_name src_dir dest_dir)
    ...
    foreach(template_file ${template_files})
        ...
        if(NOT IS_DIRECTORY ${src_template_path})
            string(REPLACE "__cbx__component" ${component_name} configured_filename ${template_file})
...
if(NEW_COMPONENT_NAME)
    set(__cbx_new_component_name "${NEW_COMPONENT_NAME}")
    set(NEW_COMPONENT_NAME 0 CACHE INTERNAL "" FORCE)
    set(template_src_dir "${CMAKE_SOURCE_DIR}/templates/template_component")
    set(template_dest_dir "${CMAKE_SOURCE_DIR}/src/${__cbx_new_component_name}")
    message(STATUS "Creating a new component called ${__cbx_new_component_name} in ${template_dest_dir}")
    make_directory(${template_dest_dir})
    message(STATUS "Configuring directory...")
    copy_template(${__cbx_new_component_name} ${template_src_dir} ${template_dest_dir})
endif()
